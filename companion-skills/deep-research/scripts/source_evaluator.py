...
Optional local heuristic for source quality, credibility, and potential biases.

This helper is not a delivery gate: delivery gates do not read this script's
numeric score. The enforced quality contract is source_tier distribution in
sources.jsonl plus audit_manifest.py warnings/critical findings. Use this
helper only to inform source_tier judgment unless a future schema persists
numeric credibility scores explicitly.
"""
