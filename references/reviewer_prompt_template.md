# Gauntlet reviewer prompt template ({{REVIEWER_MODEL}} {{REVIEWER_JUDGE_EFFORT}} judge via codex)
...
produced by a SINGLE-VENDOR research process — an {{LEAD_MODEL}} orchestrator with {{WORKER_MODEL}}
